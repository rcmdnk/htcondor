...
class htcondor (
  ...
  $multicore_priority             = $htcondor::params::multicore_priority,
  ...
  $additional_periodic_remove     = $htcondor::params::additional_periodic_remove,
  ...
  $defrag_fixed_multicore         = $htcondor::params::defrag_fixed_multicore,
) inherits
::htcondor::params {
